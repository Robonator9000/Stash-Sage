...
def run_tests():
    ...
    with sync_playwright() as p:
        ...
        for lang_name in ['English', 'Espa+¦ol', 'Fran+ºais', 'Deutsch', 'Portugu+¬s']:
        ...
        page.locator('text=Espa+¦ol').first.click()
        ...
        check("Settings button visible",
            page.get_by_role('button', name='Configuraci+¦n').is_visible())
