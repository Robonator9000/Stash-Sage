...
export function StatsCard({ products, sessions, isDark = true }: StatsCardProps) {
  ...
  const statItems = [
    ...
    { key: 'projectedRunOut' as const, visible: stats.projectedRunOut && projectedRunOut !== 'GÇö', icon: CalendarDays, label: t('projectedRunOut', settings.language), value: projectedRunOut, suffix: t('days', settings.language) },
  ];
